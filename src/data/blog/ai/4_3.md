...
title: "[AI] 迴歸問題"
author: "Rain Hu"
pubDatetime: 2025-01-12T16:39:58+08:00
description: "Regression problem"
tags: [regression, boston-housing, feature-normalization, cross-validation, keras]
---
...
\hline
\text{1st fold} & \boxed{\textcolor{red}{\text{驗證}}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \rightarrow & \text{測試分數 \\#1}\\\\
\text{2nd fold} & \boxed{\text{訓練}} & \boxed{\textcolor{red}{\text{驗證}}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \rightarrow & \text{測試分數 \\#2}\\\\
\text{3rd fold} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\textcolor{red}{\text{驗證}}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \rightarrow & \text{測試分數 \\#3}\\\\
\text{4th fold} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\textcolor{red}{\text{驗證}}} & \boxed{\text{訓練}} & \rightarrow & \text{測試分數 \\#4}\\\\
\text{5th fold} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\text{訓練}} & \boxed{\textcolor{red}{\text{驗證}}} & \rightarrow & \text{測試分數 \\#5}
\end{array}
$$
