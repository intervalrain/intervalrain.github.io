...
+ 示意圖：
    ...
    ||part1|part2|part3|pat4|part5||result|
    |---|---|---|---|---|---|---|---|
    |1st fold|**驗證**|訓練|訓練|訓練|訓練|->|測試分數#1|
    |2st fold|訓練|**驗證**|訓練|訓練|訓練|->|測試分數#2|
    |3st fold|訓練|訓練|**驗證**|訓練|訓練|->|測試分數#3|
    |4st fold|訓練|訓練|訓練|**驗證**|訓練|->|測試分數#4|
    |5st fold|訓練|訓練|訓練|訓練|**驗證**|->|測試分數#5|
