...
title: "[AI] 二元分類問題"
author: "Rain Hu"
pubDatetime: 2025-01-02T12:50:29+08:00
description: "Binary categorical classification problem"
tags: [binary-classification, imdb, sentiment-analysis, keras, text-classification]
---
...
+ 我設計以下的三層神經網路架構：  
    ...
    plt.show()
    ```
    ![validation1](/ai/4_1/validation_plot1.png)
    + 繪製訓練和驗證準確度
    ```python
    plt.clf()
    ...
    plt.legend()
    ```
    ![validation2](/ai/4_1/validation_plot2.png)
    ...
    ```
    ![validation_plot_with_early_stopping_1](/ai/4_1/validation_plot_es1.png)
    ![validation_plot_with_early_stopping_1](/ai/4_1/validation_plot_es2.png)
    + 拿來測試驗證集
    ```python
