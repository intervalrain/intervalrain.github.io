...
author: "Rain Hu"
pubDatetime: 2024-12-16T15:48:11+08:00
description: "The concept of optimizer in machine learning"
tags: [optimizer, gradient-descent, backpropagation, learning-rate, loss-function]
---
...
![gradient_descent](/ai/2_3/gradient-descent.png)
...
$
    ...
    && \text{輸入資料 X} & \\
    && \downarrow & \\
    \\boxed{\text{權重'}} & \rightarrow & \boxed{\text{層(資料轉換)}} & \textcolor{red}{\text{relu(W1,b1)}}\\
    \uparrow && \downarrow & \\
    \\boxed{\text{權重'}} & \rightarrow & \boxed{\text{層(資料轉換)}} & \textcolor{red}{\text{softmax(W1,b2)}}\\
    && \downarrow & \\
...
根據連鎖律
$$
    y=f(x_1,x_2,x_3...x_n),\frac{d\text{y}}{d\text{x}}=\textcolor{red}{\frac{d\text{y}}{d\text{x}_1}\times\frac{d\text{x}_1}{d\text{x}_2}\times\frac{d\text{x}_2}{d\text{x}_3}\times...\times\frac{d\text{x}_n}{d\text{x}}}
$$
