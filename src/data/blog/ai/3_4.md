...
title: "[AI] 3-4. 線性迴歸"
author: "Rain Hu"
pubDatetime: 2024-12-19T15:01:12+08:00
description: "The introduction to linear regression"
tags: [linear-regression, supervised-learning, loss-function, gradient-descent]
---

## 目標
+ 機器學習的目標有很多種，參考李宏毅教授的機器學習課程，可以用下面一張圖來概述。
![terminology](/ai/3_4/terminology.png)
    + Task 代表機器學習的目標
        + Regression: 透過迴歸來預測值。
...
+ `w=35.1`
+ `b=599`
![brute_force](/ai/3_4/brute_force.png)
...
![regularization](/ai/3_4/relugarization.png)
+ 觀察重點：
    + L1 正則化（Lasso）：
...
+ 以下為三個重要的激活函數
    ![activation](/ai/3_4/Curves-of-the-Sigmoid-Tanh-and-ReLu-activation-functions.png)    
...
plt.show()
``` 
![loss_plot](/ai/3_4/loss_plot.png)
![prediction_plot](/ai/3_4/prediction.png)
...
+ 優化器是 backpropagation 時使用的更新策略，常見的優化器有：
    ...
    def update(self, params, grads):
        ...
        return params
    ```
    ![optimizer](/ai/3_4/optimizer.png)
