...
title: "[AI] 提升模型的表現"
author: "Rain Hu"
pubDatetime: 2025-01-12T17:54:27+08:00
description: "How to enhance the performance of the model"
tags: [model-tuning, learning-rate, overfitting, gradient-descent, batch-size]
---
+ 要達到完美擬合(perfect fit)，勢必要先經歷過度擬合(overfitting)，否則我們無法預先知道邊界在哪裡。
![perfect_fit](/ai/5_3/perfect_fit.png)
...
![capacity_comparison](/ai/5_3/capacity_comparison.png)
...
<details>
<summary>用 n 次方程式來說明模型容量的差異程式碼</summary>
