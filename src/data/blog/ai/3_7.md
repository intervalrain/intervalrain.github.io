...
author: "Rain Hu"
pubDatetime: 2024-12-20T15:49:27+08:00
description: "A introduction to Keras API"
tags: [keras, layer, model, sequential, functional-api, dense-layer]
---
# 基礎篇
## 1. Layer
...
model.summary()
```
![functional_api](/ai/3_7/functional_api.png)
...
```
![plot_model](/ai/3_7/plot_model.png)
...
```
![add_output](/ai/3_7/add_output.png)
...
```
![tensorboard](/ai/3_7/tensorboard.png)
