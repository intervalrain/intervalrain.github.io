...
title: "[AI] 1-1. 何謂人工智慧?"
author: "Rain Hu"
pubDatetime: 2024-12-03T15:39:11+08:00
description: "What is artificial intelligence?"
tags: ["artificial-intelligence", "machine-learning", "deep-learning", "neural-network", "backpropagation"]
---

人工智慧(Artificial Intelligence, 簡稱 AI)，但何謂人工智慧？  
首先我們先探討**人工智慧**、**機器學習**、**深度學習**之間的關係。
<img src="https://www.researchgate.net/publication/372366661/figure/fig1/AS:11431281178493092@1690937679899/Ov-ervie-w-of-AI-ML-and-DL.ppm" width="400" />  
...
![Allinside](/ai/1_1/AIinside.jpeg)
...
&& \text{輸入資料 X} & \\\\
&& \downarrow & \\\\
\textcolor{red}{\boxed{\text{權重}}} & \textcolor{red}{\rightarrow} & \boxed{\text{層(資料轉換)}} \\\\
&& \downarrow & \\\\
\textcolor{red}{\boxed{\text{權重}}} & \textcolor{red}{\rightarrow} & \boxed{\text{層(資料轉換)}} \\\\
&& \downarrow & \\\\
&& \boxed{\text{預測 Y'}} &
...
\boxed{\text{權重}} & \rightarrow & \boxed{\text{層(資料轉換)}} \\\\
&& \downarrow & \\\\
&& \boxed{\text{預測 Y'}}\textcolor{red}{\rightarrow} & \textcolor{red}{\boxed{\text{損失函數}}} & \textcolor{red}{\leftarrow} & \textcolor{red}{\boxed{\text{標準答案 Y}}} \\\\
&&& \textcolor{red}{\downarrow} & \\\\
&&& \textcolor{red}{\boxed{\text{損失分數}}}
\end{array}
}
$$
...
&& \text{輸入資料 X} & \\\\
&& \downarrow & \\\\
\textcolor{red}{\boxed{\text{權重'}}} & \rightarrow & \boxed{\text{層(資料轉換)}} \\\\
\textcolor{red}{\uparrow} && \downarrow & \\\\
\textcolor{red}{\boxed{\text{權重'}}} & \rightarrow & \boxed{\text{層(資料轉換)}} \\\\
&& \downarrow & \\\\
\textcolor{red}{\uparrow} && \boxed{\text{預測 Y'}}\rightarrow & \boxed{\text{損失函數}} & \leftarrow & \boxed{\text{標準答案 Y}} \\\\
&&& \downarrow & \\\\
\textcolor{red}{\boxed{\text{優化器}}} && \textcolor{red}{\leftarrow}  & \boxed{\text{損失分數}}
\end{array}
}
$$
