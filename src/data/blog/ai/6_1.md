...
title: "[AI] 卷積神經網路"
author: "Rain Hu"
pubDatetime: 2025-02-03T00:18:32+08:00
description: "Introduction to CNN"
tags: [cnn, convolutional-neural-network, image-classification, pooling, receptive-field, mnist]
---
...
![kernel](/ai/6_1/kernel.png)
![receptive_field](/ai/6_1/RetinalReceptiveField.png)
...
+ 卷積層(convolutional layer) 的兩個特性
  ...
  + 使他提供了兩項有趣的性質：
    ...
    ![spatial_hierarchies](/ai/6_1/spatial_hierarchies.png)
...
![max_pooling](/ai/6_1/max_pooling.png)
+ max pooling 達到的效果有：
  + 降採樣，可以減少所需的計算量。
