...
title: "[AI] 多元分類問題"
author: "Rain Hu"
pubDatetime: 2025-01-06T22:58:45+08:00
description: "Multi categorical classification problem"
tags: [multi-class-classification, reuters, text-classification, softmax, keras]
---
...
+ 我設計以下的三層神經網路架構：  
    ...
    plt.show()
    ```
    ![validation1](/ai/4_2/validation_plot1.png)
    ```python
    plt.clf()
    ...
    plt.show()
    ```
    ![validation2](/ai/4_2/validation_plot2.png)
