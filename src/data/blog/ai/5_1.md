...
title: "[AI] 普適化"
author: "Rain Hu"
pubDatetime: 2025-01-12T17:52:09+08:00
description: "Introduction to generalization"
tags: [generalization, overfitting, underfitting, regularization, spurious-correlation]
---
> 機器學習最重要的兩件事是：  
> 1. 準確的模型評估  
> 2. 訓練次數與普適化之間的平衡
...
![noise_test](/ai/5_1/noise_test.png)
```python
...
plt.legend()
```
![loss_curve](/ai/5_1/loss_curve.png)
...
plt.show()
```
![random_label_test](/ai/5_1/random_label_test.png)
...
plt.show()
```
![manifold](/ai/5_1/manifold.png)

</details>

### 以內插法作為普適化的基礎
+ 深度學習的普適化能力，很大程度上依賴於模型能夠在訓練數據的流形上進行合理的內插。讓我們通過實驗來比較**流形內插**和**線性內插**的差異：
![interpolation](/ai/5_1/interpolation.png)

<details>
<summary>內插法程式</summary>
...
![regularization](/ai/5_1/regularization.png)