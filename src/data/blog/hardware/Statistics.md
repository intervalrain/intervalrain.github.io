...
title: "[統計] 統計學概要"
author: "Rain Hu"
pubDatetime: 2022-07-09T20:02:28+08:00
...
+ **群體(population)**：研究對象的主體。
    + 如上例的$\textcolor{red}{\text{全國人民的政治傾向}}$、$\textcolor{red}{\text{此家工廠的產品品質}}$。
+ **樣本(sample)**：群體的一部分。
    + 如上例的$\textcolor{red}{\text{台灣部分的民眾}}$、$\textcolor{red}{\text{工廠部分的抽樣}}$。
        + 目的：了解美國總統大選誰會獲勝?
        + 群體：美國有投票權的公民
...
+ 統計的目的：$\textcolor{red}{\text{由樣本資料推論母體參數}}$。  
...
+ 偏態：數據分佈的「形態」口訣：$\textcolor{red}{\text{平地、山腰、種樹}\rightarrow\text{平均數、中位數、眾數}}$
    + 對稱：$\textcolor{red}{\text{平均數=中位數=眾數}(山頂在中間)}$
    + 右偏、正偏：$\textcolor{red}{\text{平均數>中位數>眾數}(山頂在左邊)}$
    + 左偏、負偏：$\textcolor{red}{\text{平均數<中位數<眾數}(山頂在右邊)}$
    ...
    + 偏態係數 $\text{g}_1$
        ...
        + $\textcolor{red}{\text{g}_1\text{=0表示對稱}}$
        + $\textcolor{red}{\text{g}_1\text{>0表示右偏}}$
        + $\textcolor{red}{\text{g}_1\text{<0表示左偏}}$
+ 峰態：山頂高不高
    + 峰度係數 $\text{g}_2$
        + $\gray{\text{g}_1=\frac{\sum_i^n(X_i-\bar{X})^4/(n-1)}{S^4}-3}$
        + $\textcolor{red}{\text{g}_2\text{=0表示常態分佈}}$
        + $\textcolor{red}{\text{g}_2\text{>0表示高狹峰}}$
        + $\textcolor{red}{\text{g}_2\text{<0表示低濶峰}}$
...
+ 若一組資料滿足自然分布(高斯分布、常態分布、正態分布、鐘型分布)，便會滿足以下的性質。
    ...
    + 百分等級
        ...
        $\text{PR=}100\times 70\\%+\frac{50}{\textcolor{red}{10}}=70+5=75$
        + 小明如果考 90 分，則此次考試 PR 75 的原始分數即為 90 分。
        + 小明如果在 50 個人中排第 15 名，同樣的累計百分比為 70 %，但是 PR 值變成 
        $\text{PR=}100\times 70\\%+\frac{50}{\textcolor{red}{50}}=70+1=71$
        + 小明如果是參加五萬人的選拔，同樣贏過 70% 的人，  
        $\text{PR=}100\times 70\\%+\frac{50}{\textcolor{red}{50000}}=70+0.001=70.001\approx70\\\\
        \textcolor{red}{\text{PR只分100個等級，故不會有小數點，所以要四捨五入，}\\\\\text{換言之，受試者超過101人，PR=Ppr}}$
    + 累積百分比與標準差
